...
import com.powernow.usm.common.DmStatus;
...
public class GlobalExceptionAdvice {
    ...
    public HttpResult<Object> sendErrorResponse(BizException exception){
...
//    @ExceptionHandler(NoBindingException.class)
//    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
//    public HttpResult<Object> sendErrorResponse(NoBindingException exception){
//        log.error("未绑定手机号异常: {}", getStackTrace(exception));
//        return HttpResult.failureResult(DmStatus.NO_BINDING_ERROR.getHttpStatus().value(),exception.getLocalizedMessage());
//    }
    ...
    /**
     * 没有此方法异常
     * @param exception NoSuchMethodError
     * @return 返回消息
     */
    @ExceptionHandler(NoSuchMethodError.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public HttpResult<Object> sendErrorResponse(NoSuchMethodError exception){
        log.error("系统运行时异常: {}", getStackTrace(exception));
        return HttpResult.failureResult(DmStatus.SYS_RUNTIME_ERROR.getHttpStatus().value(),exception.getLocalizedMessage());
    }
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public HttpResult<Object> sendErrorResponse(NullPointerException exception){
        return HttpResult.failureResult(DmStatus.MAX_UPLOAD_SIZE_EXCEEDED.getHttpStatus().value(),exception.getLocalizedMessage());
    }
